...
export const DARK_THEME_KEY = "mermaid.vscode.dark";
export const LIGHT_THEME_KEY = "mermaid.vscode.light";
export const MAX_ZOOM= "mermaid.vscode.maxZoom";
export const MAX_CHAR_LENGTH = "mermaid.vscode.maxCharLength";
export const MAX_EDGES = "mermaid.vscode.maxEdges";
